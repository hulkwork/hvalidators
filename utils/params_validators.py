...
def put_all_valid_params():
    ...
    valid_params_hazel = valid_params_hazel if valid_params_hazel is not None else {}
    error_params_hazel = error_params_hazel if error_params_hazel is not None else {}
